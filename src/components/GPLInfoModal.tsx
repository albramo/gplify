...
const PILLARS = [
  ...
  },
  {
    ...
    text: 'رسوم رمزية لتغطية السيرفرات والفحص الأمني وإعادة التوزيع — بدل الأسعار الباهظة.',
  },
];
...
const FAQ = [
  ...
  {
    q: 'هل الشراء يشمل التحديثات المستقبلية؟',
    a: 'لا. بتستلم ملفات النسخة المتاحة وقت الشراء زي ما هي من المصدر بدون أي تعديل — بدون تحديثات تلقائية وبدون إرسال تلقائي للإصدارات الجديدة على البريد.',
  },
];
